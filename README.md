...
A Music Generation system that trains an LSTM neural network on classical piano MIDI data to compose original, royalty-free background music — packaged as an interactive Streamlit web application.

---

## 📖 Overview
 
This project implements a complete **Music Generation pipeline**:
...
It's then wrapped in a **Streamlit web app** that lets a user pick a mood and track length, generate a track, listen to it in-browser, and download it — framed as a **Background Music Generator** for videos, streams, and creative projects.
